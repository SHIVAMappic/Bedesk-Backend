              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="title" id="title"  value="{{$ads->title}}" class="form-control" />
                    </div>
                  </div>
                  <input type="hidden"  name="record_id"  value="{{$ads->id}}">

                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Description</label>
                    <div class="col-sm-9">
                      <textarea name="description" id="description" rows="20" class="form-control" >{{$ads->description}}</textarea>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="link" id="link"  value="{{$ads->link}}" class="form-control" />
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="form-group">
                    <label> Image</label>
                    <input type="file" name="blog_image" class="file-upload-default  sf1">
                ...
                <div class="col-md-6">
                  <div class="form-group"> 
                     <img src="{{URL::to('/')}}/public/storage/galeryImages/<?php echo $ads->image;?>" style="height:200px;width:200px;"></div>
                </div>
              </div>
            </div>   
      ...
      var formData= new FormData(jQuery('#add_product')[0]);
        ...
        jQuery.ajax({
            ...
            contentType: false,
              cache: false,
            beforeSend: function() { 
              jQuery('button[name="submit"]').html('Updating ....');
              ...
              obj = JSON.parse(data);
                ...
                // jQuery("#register")[0].reset();
                 jQuery('.ajaxMsg').show().addClass('ajaxSucc').removeClass('ajaxErr').html(obj.message);
                  setTimeout(function(){
                    jQuery('button[name="submit"]').html('Update');
