    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-12 stretch-card">
          <div class="card">
            <div class="card-body">
              <p class="card-title">Ads Manager
                  <a href="{{url('/admin/ads-manager/addAds')}}" class="btn btn-primary" style="float:right;">Add Ads</a>
              </p>
               <div id="table_data">
                  @include('ads-manager.pagination_data')
               </div>              
            </div>
          </div>
        </div>
