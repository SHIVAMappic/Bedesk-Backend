                        ...
                        <table id="recent-purchases-listing" class="table">
                           ...
                           <tbody>
                              ...
                              <tr  id="{{$user->id}}">
                                 ...
                                 <td>
                                    <a href="{{url('admin/users/viewUser',$user->id)}}" class="btn btn-info  "> <i class="fa fa-eye" aria-hidden="true"></i></a>
                                    <a href="{{url('admin/users/editUser',$user->id)}}" class="btn btn-success "><i class="fa fa-edit"></i></a>
                                   <!--- <button type="button"  onclick="deleteRecord(this)"
                                       data-url="{{url('admin/users/editWord')}}" data-token="{{ csrf_token() }}" data-id="{{$user->id}}" class="btn btn-danger "><i class="fa fa-trash"></i></button>---->
                                 </td>
                              </tr>
                              <?php  $i++;?>
                              @endforeach
