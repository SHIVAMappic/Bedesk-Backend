    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-12 stretch-card">
          <div class="card">
            <div class="card-body">
              <p class="card-title">Newsletter
                  <a href="{{url('/admin/newsletter/addNewsletter')}}" class="btn btn-primary" style="float:right;">Add Newsletter</a>
              </p>
               <div id="table_data">
                  @include('newsletter.pagination_data')
               </div>              
            </div>
          </div>
        </div>
...
<script>
  function deleteRecord($this){          
    ...
    if(confirm('Are You sure want to delete this record!')){
      jQuery.ajax({
        url: "/bedesk/deleteNewsletterAction",
        type:'POST',
