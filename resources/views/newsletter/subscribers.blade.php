    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-12 stretch-card">
          <div class="card">
            <div class="card-body">
              <p class="card-title">Subscribers
                <!--  <a href="{{url('/admin/blogs/addBlog')}}" class="btn btn-primary" style="float:right;">Add Blog</a>-->
              </p>
               <div id="table_data">
                  @include('newsletter.subscribers_pagination_data')
               </div>              
            </div>
          </div>
        </div>
