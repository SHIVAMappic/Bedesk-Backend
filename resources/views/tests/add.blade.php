...
<div class="col-12 grid-margin">
   <div class="card">
      <div class="card-body">
         ...
         <form class="form-sample addproduct" id="add_product11" method="post" enctype="multipart/form-data" action="">
            <!-- Start row form box ---->
            <div class="rowForm">
                    ...
                    var obj = JSON.parse(data);
                      ...
                      if(obj.status=='true'){
                        ...
                        setTimeout(function(){
                          ...
                          jQuery("#errors").html('');
                          window.location= "{{url('/admin/blogs')}}";
                        }, 3000);
                      }else{
