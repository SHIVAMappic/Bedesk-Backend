                        ...
                        <div class="card">
                           <div class="card-body">
                                    ...
                                    <div class="col-md-12 stretch-card">
                                       <div class="card">
                                          <div class="card-body">
                                             <p class="card-title">View BLOG
                                              <a href="{{url('/admin/blogs')}}" style="float:right;"  class="btn btn-secondary" >Back</a>
                                             </p>
                                             <div class="table-responsive">
                                                <table id="recent-purchases-listing" class="table">
                                                   ...
                                                   <tr>
                                                      <th>Image</th>
                                                      <td> <img src="{{URL::to('/')}}/public/storage/galeryImages/<?php echo $blogs->blog_image;?>" style="height:200px;width:200px;"></td>
                                                   </tr>
