         ...
         <form class="form-sample addproduct" id="add_product" method="post" enctype="multipart/form-data" action="">
            ...
            <div class="rowForm">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <input type="hidden"  name="record_id"  value="{{$blogs->id}}">

                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Description</label>
                    <div class="col-sm-9">
                      <textarea name="content" id="content" rows="20" class="form-control" >{{$blogs->content}}</textarea>
                    </div>
                  </div>
            ...
            <div class="rowForm">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group"> 
                     <img src="{{URL::to('/')}}/public/storage/galeryImages/<?php echo $blogs->blog_image;?>" style="height:200px;width:200px;"></div>
                </div>
              </div>
            </div>   
