                                                   ...
                                                   <tbody>
                                                     ...
                                                     <?php  $i = 1; ?>
                                                      ...
                                                      <tr  id="{{$words->id}}">
                                                         ...
                                                         <td></td>
                                                         <td>
                                                            <a href="{{url('admin/dms/viewWord',$words->id)}}" class="btn btn-info  "> <i class="fa fa-eye" aria-hidden="true"></i></a>
                                                            <a href="{{url('admin/dms/editWord',$words->id)}}" class="btn btn-success "><i class="fa fa-edit"></i></a>
                                                             <button type="button"  onclick="deleteRecord(this)"
                                                              data-url="{{url('admin/dms/editWord')}}" data-token="{{ csrf_token() }}" data-id="{{$words->id}}" class="btn btn-danger "><i class="fa fa-trash"></i></button>
                                                         </td>
                                                      </tr>
                                                     <?php  $i++;?>
                                                      @endforeach
