            ...
            <div class="rowForm">
              ...
              <div class="row">
                <div class="col-md-12">
                 ...
                 /* $str = 'https:://shivam.com/images/dog.jpg';
                  $ss = explode('/',$str);
                  echo '<pre>';
                  print_r($ss);
                  echo '</pre>';
                  $dd = array($ss[0],'//',$ss[2],'/public/',$ss[3],'/',$ss[4]);
                  $kk = implode($dd);
                  echo '<pre>';
                  print_r($kk);
                  echo '</pre>';*/
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="item[]" id="item2" class="form-control" />
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="item[]" id="item3" class="form-control" />
                    </div>
                  </div>
         ...
         jQuery("#add_product").each(function(e, a) {
          ...
          submitHandler: function (form) { 
            var formData= new FormData(jQuery('#add_product')[0]);
              ...
              jQuery.ajax({
                  url: "/bedesk/addSubscriptionAction",
                  type:'POST',
                  data:formData,
                  processData: false,
                  contentType: false,
                  ...
                  success: function(data) { // console.log(data);
                    var obj = JSON.parse(data);
                      ...
                      if(obj.status=='true'){
                        ...
                        //window.location= "{{url('/admin/subscription')}}";
