                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                          <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                <input type="text" name="word_name" id="word_name"  value="{{$words->word_name}}" class="form-control" />
                                             </div>
                                          </div>
                                          <div class="form-group row">
                                             <label class="col-sm-3 col-form-label">Meaning</label>
                                             <div class="col-sm-9">
                                                <input type="text" name="meaning" id="meaning" value="{{$words->meaning}}"  class="form-control" />
                                             </div>
                                          </div>                                          
                                             ...
                                             <div class="col-sm-9">
                                                <select name="category"  class="form-control">
                                                   ...
                                                   @foreach($allCategories as $category)
                                                      @if($words->category_id == $category->id)
                                                         <?php $selected = 'selected';?>
                                                      @else
                                                      <?php $selected = '';?>
                                                      @endif
                                                      <option value="{{$category->id}}"  <?php echo $selected;?>>{{$category->category_name}}</option>
                                                   @endforeach
                                                </select>
                                             </div>
                                          </div>
                                          ...
                                          <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                <input type="text" value="{{$words->synonyms}}"   name="synonyms" id="synonyms" class="form-control" />
                                             </div>
                                          </div>
                                          <div class="form-group row">
                                             <label class="col-sm-3 col-form-label">Antonyms</label>
                                             <div class="col-sm-9">
                                                <input type="text" name="antonyms" id="antonyms"  value="{{$words->antonyms}}"   class="form-control" />
                                             </div>
                                          </div>
                                       </div>

                                       <input type="hidden"  name="record_id"  value="{{$words->id}}">
                                       <!--<div class="col-md-12">
                                          <div class="form-group row">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-5">
                                          <div class="form-group">
                                             ...
                                             <input type="file" name="word_video" class="file-upload-default sf4">
                                             <div class="input-group col-xs-12">
