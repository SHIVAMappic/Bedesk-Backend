                                          ...
                                          <div class="card-body">
                                             ...
                                             <div class="table-responsive">
                                                <table id="recent-purchases-listing" class="table">
                                                   ...
                                                   <tr>
                                                      <th>Synonyms</th>
                                                      <td>{{$words->synonyms}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th>Antonyms</th>
                                                      <td>{{$words->antonyms}}</td>
                                                   </tr>
                                                   <tr>
                                                      <th>Image</th>
                                                      <td><?php if(!empty($words->word_image)){?><img src="{{URL::to('/')}}/public/storage/galeryImages/<?php echo $words->word_image;?>" style="height:100px;width:100px;border-radius:none;"><?php }?></td>
                                                   </tr>
                                                   <tr>
                                                      <th>Audio</th>
                                                      <td></td>
                                                   ...
                                                   <tr>
                                                      <th>Document</th>
                                                      <td><?php if(!empty($words->word_document)){?><a href="{{URL::to('/')}}/public/storage/galeryImages/<?php echo $words->word_document;?>"  download><img src="{{URL::to('/')}}/public/storage/galeryImages/document-pdf.jpg" style="height:100px;width:100px;border-radius:none;"></a><?php }?></td>
                                                   </tr>
                                                    <tr>
                                                      <th>Add Date</th>
