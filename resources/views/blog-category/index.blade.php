                                       ...
                                       <div class="card">
                                          <div class="card-body">
                                             <p class="card-title">Category
                                              <a href="{{url('admin/blog-category/add-category')}}" style="float:right;" class="btn btn-primary">Add Category</a></p>
                                                   ...
                                                   <tbody>
                                                     ...
                                                     <?php  $i = 1; ?>
                                                      ...
                                                      <tr  id="{{$category->id}}">
                                                         ...
                                                         <td>
                                                          <!--  <a href="{{url('admin/dms/viewWord',$category->id)}}" class="btn btn-info  "> <i class="fa fa-eye" aria-hidden="true"></i></a>--->
                                                            <a href="{{url('admin/blog-category/edit',$category->id)}}" class="btn btn-success "><i class="fa fa-edit"></i></a>
                                                             <button type="button"  onclick="deleteRecord(this)"
                                                              data-url="{{url('admin/blog-category/delete')}}" data-token="{{ csrf_token() }}" data-id="{{$category->id}}" class="btn btn-danger "><i class="fa fa-trash"></i></button>
                                                         </td>
                                                      </tr>
                                                     <?php  $i++;?>
                                                      @endforeach
     ...
     <script>
         ...
         function deleteRecord($this){
            ...
            var url = $($this).attr('data-url');
             ...
             jQuery.ajax({
                 url: "/bedesk/deleteBlogCategoryAction",
                 type:'POST',
