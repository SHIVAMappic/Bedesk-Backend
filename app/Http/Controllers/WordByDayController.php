...
class WordByDayController extends Controller
{
    public function index() {
        ...
        $allWords = DB::table('words')
            ...
            ->where('type','wordOfTheDay')
            ->orderby('id','desc')
            ->get();
        return view('wordByDay.index',compact('allWords','pageTitle'));
    }

    public function addWord() {
        $pageTitle = 'Add Word of the Day';
        $allCategories = DB::table('category')->orderby('id','desc')->get();
    	return view('wordByDay.addWord',compact('allCategories','pageTitle'));
    }
    ...
    public function editWord($id){
        ...
        return view('wordByDay.editWord',compact('words','pageTitle'));
    ...
    public function viewWord($id){
        ...
        return view('wordByDay.viewWord',compact('words','pageTitle'));
    }
